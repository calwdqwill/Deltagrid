  ...
  releaseChecklist: [
    {
      ...
      statusTone: "neutral",
      evidence: "Static preview data only",
      nextAction: "Use live data for release checklist",
      boundary: "Fixture release readiness only; not trading or execution signal",
    },
    {
      area: "Safety Boundary",
      status: "Read-only locked",
      statusTone: "positive",
      evidence: "Fixture keeps forbidden outputs disabled",
      nextAction: "Verify live smoke safety flags",
      boundary: "Fixture safety boundary only; no execution path",
    },
  ],
  sourceStatus: [
    {
      source: "Fixture funding history",
      scope: "Static preview data",
      loadedRows: "0",
      latest: "No rows",
      ...
      sync: "Not tracked",
      syncTone: "neutral",
      boundary: "Preview fixture; not production data",
    },
  ],
  freshnessAnomalies: [
    {
      ...
      latestRate: "No rate",
      lastChange: "No rate",
      dataStatus: "Fixture only",
      dataTone: "neutral",
      anomaly: "Not evaluated",
      anomalyTone: "neutral",
      boundary: "Fixture data QA only; not carry, route or execution signal",
    },
  ],
  sourceComparisons: [
    {
      asset: "BTC",
      okxRate: "No rate",
      coinglassRate: "No rate",
      sourceDelta: "No rate",
      latestPair: "OKX No rows / CoinGlass No rows",
      status: "Fixture only",
      statusTone: "neutral",
      dataNote: "Static preview data",
      dataTone: "neutral",
      boundary: "Fixture comparison only; not route ranking, carry or execution signal",
    },
  ],
  qaDrilldown: [
    {
      ...
      freshness: "Fixture only",
      freshnessTone: "neutral",
      freshnessReason: "Static preview data",
      coverage: "Not tracked",
      coverageTone: "neutral",
      coverageReason: "Static preview data",
      sync: "Not tracked",
      syncTone: "neutral",
      nextAction: "Use live data for QA drilldown",
      boundary: "Fixture drilldown only; not carry, route ranking or execution signal",
    },
  ],
  anomalyDetails: [
    {
      ...
      status: "Fixture only",
      statusTone: "neutral",
      nextReview: "Use live data for anomaly detail",
      boundary: "Fixture anomaly detail only; not trading, carry, route ranking or execution signal",
    },
  ],
  historyDiagnostics: [
    {
      ...
      interval: "unknown",
      averageRate: "No rate",
      observedRange: "No rate",
      status: "Fixture only",
      statusTone: "neutral",
      nextAction: "Use live data for history diagnostics",
      boundary: "Fixture history diagnostics only; not strategy, carry, ranking or execution signal",
    },
  ],
  historyControls: [
    {
      ...
      status: "Fixture only",
      statusTone: "neutral",
      reason: "Static BTC selection for funding history preview",
      nextAction: "Use live data for history controls",
      boundary: "Fixture history control only; not strategy or execution signal",
    },
    {
      control: "Source",
      selection: "CoinGlass",
      status: "Fixture only",
      statusTone: "neutral",
      reason: "Static source selection for funding history preview",
      nextAction: "Use live data for source readiness",
      boundary: "Fixture source selector is display-only; not provider ranking",
    },
  ],
  historyReadiness: [
    {
      ...
      statusTone: "neutral",
      evidence: "Static preview data only",
      nextAction: "Use live data for history readiness",
      boundary: "Fixture readiness only; not trading or execution signal",
    },
    {
      check: "Chart Empty State",
      status: "Fixture only",
      statusTone: "neutral",
      evidence: "Static preview does not represent persisted funding rows",
      nextAction: "Use live data for empty-state review",
      boundary: "Fixture empty-state explanation only; not a product signal",
    },
  ],
