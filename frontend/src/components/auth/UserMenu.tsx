  ...
  if (!isAuthenticated) {
    return (
      <button
        ...
        className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium border border-border hover:bg-row-hover transition-colors"
      >
        ...
        <>
          ...
          <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-lg border border-border shadow-lg z-50 py-1">
            <div className="px-4 py-2 border-b border-border">
              ...
              <div className="text-xs text-secondary-text capitalize">{user?.plan}</div>
            </div>
            <button
              onClick={() => {
                logout();
              ...
              className="w-full flex items-center gap-2 px-4 py-2 text-sm text-negative hover:bg-red-50 transition-colors"
            >
