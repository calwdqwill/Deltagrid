...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('web_push_enabled', sa.Boolean(), server_default='0'),
        sa.Column('web_push_subscription_json', sa.Text(), nullable=True),
        sa.Column('telegram_enabled', sa.Boolean(), server_default='0'),
        sa.Column('telegram_chat_id', sa.String(), nullable=True),
        sa.Column('market_alerts_enabled', sa.Boolean(), server_default='1'),
        sa.Column('execution_alerts_enabled', sa.Boolean(), server_default='1'),
        sa.Column('risk_alerts_enabled', sa.Boolean(), server_default='1'),
